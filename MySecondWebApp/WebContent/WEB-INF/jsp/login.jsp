...
<body>
	<form action="${pageContext.request.contextPath}/processLogin" method="GET"><br><br><br><br><br><br><br><br><br><br>	
		<div align="center">
		...
		<div align="center">
			 Don't have an account? <a href="${pageContext.request.contextPath}/processRegister">Sign Up</a>
		</div><br><br>
		<div align="center">
			<a href="${pageContext.request.contextPath}/processResetPassword">Forget Password</a>
		</div>
</body>
